          ...
          <article className="block mb-4">
            ...
            <div className={``}>
              <input
                type="text"
                name="name"
                className=" block w-full px-4 py-2 h-[50px] font-normal bg-backgroundGrey bg-clip-padding rounded-md transition ease-in-out m-0 placeholder:text-backgroundGrey placeholder: focus:bg-transparent focus:border-textGrey focus:outline-none"
