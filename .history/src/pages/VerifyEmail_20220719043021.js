          ...
          <div>
            <form>
              <input
                ...
                type=""
                name="email"
                className=" w-[40px] px-[5px] text-center flex items-center justify-center h-[40px] font-normal bg-transparent bg-clip-padding border border-solid border-backgroundGrey rounded-md transition ease-in-out  placeholder:text-backgroundGrey placeholder: focus:bg-transparent focus:border-textGrey focus:outline-none"
                placeholder="0"
              />
            </form>
          </div>
