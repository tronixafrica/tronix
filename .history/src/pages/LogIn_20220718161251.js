        ...
        <div className="w-[450px]  h-fit rounded-md  px-6 scrollbar-hide">
          ...
          >
            ...
            <article className="flex items-center justify-between w-full mt-16">
              <button
                type="button"
                className={`flex justify-center items-center px-4 h-12 w-24 grow font-bold text-white rounded-md bg-backgroundGrey border border-solid border-backgroundGrey hover:brightness-90`}
              >
            ...
            <article className="flex items-center justify-between w-full mt-10">
              <button
                type="submit"
                className={`flex justify-center items-center px-4 h-12 w-24 grow font-bold text-white rounded-md bg-[#D20202] hover:brightness-90`}
              >
