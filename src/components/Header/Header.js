...
const Header = () => {
  ...
  return (
    <div
      className={`sticky top-0 px-6 py-[2rem] h-[9rem] sm:h-[8rem] bg-backgroundGrey flex sm:flex-row flex-col-reverse justify-between sm:items-center transition-all z-[10000]`}
    >
      {/* start page title */}
