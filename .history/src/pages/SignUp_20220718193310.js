...
const SignUp = () => {
  ...
  return (
    <>
      ...
      <section className="bg-red-500 overflow-y-auto w-full flex h-full items-center justify-center py-7">
        <div className="w-[450px] h-full bg-blue-600 rounded-md  px-5 scrollbar-hide">
          {/*Start of Header */}
