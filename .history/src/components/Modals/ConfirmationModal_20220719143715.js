    ...
    >
      ...
      >
        <motion.section
          ...
          animate="animate"
          exit="exit"
          className="w-[450px] max-w-[450px] min-h-[300px] border rounded-lg bg-black border-[#686868] px-7 py-10 "
          onClick={(e) => e.stopPropagation()}
        >
          <article className="w-full flex justify-center mb-4 stroke-backgroundRed ">
            <svg
