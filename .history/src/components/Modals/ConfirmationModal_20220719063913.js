    ...
    >
      ...
      >
        <motion.section
          ...
          animate="animate"
          exit="exit"
          className="w-[450px] max-w-[450px] min-h-[450px] border rounded-md bg-black border-secondary-dark px-10 py-10 "
        ...
        >
          ...
          <article className="w-full flex justify-center items-center">
            <button
              type="button"
              className=" py-2 px-4 flex justify-center items-center min-w-[8rem] rounded-full bg-primary-light"
            >
              Confirm
            </button>
          </article>
