        ...
        <div className="w-[450px] h-full rounded-md  px-5 scrollbar-hide">
          ...
          >
            ...
            <article className="flex items-center justify-between w-full mt-5">
              <button
                type="button"
                className={`flex justify-center items-center px-4 h-12 w-24 grow text-white rounded-md bg-backgroundGrey border border-solid border-[rgba(218, 218, 218, 0.15)] hover:brightness-90`}
              >
