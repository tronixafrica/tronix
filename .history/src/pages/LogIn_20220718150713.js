                    ...
                    <input
                      ...
                      onBlur={(e) => {
                        ...
                        formik.values.password.length === 0 &&
                          setPasswordLabelTranslate(false);
                      }}
                    />
                    <label
                      htmlFor="password"
                      className={` text-base absolute top-0 left-0 transition-all transform ${
                        passwordLabelTranslate
                          ? "text-primary-light -translate-y-2 scale-90 font-bold"
                          : "translate-y-4 text-secondary-light"
                      } duration-300`}
                    >
                      Password
                    </label>
