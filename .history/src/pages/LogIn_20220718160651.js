        ...
        <div className="w-[450px]  h-fit rounded-md  px-6 scrollbar-hide">
          ...
          >
              ...
              <article className="block mb-4">
                <div className={``}>
                  <input
                    type="email"
                    name="email"
                    className=" block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-transparent bg-clip-padding border-2 border-solid border-backgroundGrey rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-transparent focus:border-blue-600 focus:outline-none"
            ...
            <article className="flex items-center justify-between w-full mt-16">
              <button
                type="submit"
                className={`flex justify-center items-center px-4 h-12 w-24 grow font-bold text-white rounded-full bg-red-500 hover:brightness-90`}
              >
