          ...
          <div>
            <form>
              <input
                ...
                type=""
                name="email"
                className=" w-[40px] text-center h-[40px] font-normal bg-transparent bg-clip-padding border border-solid border-[#dadadac2] rounded-md transition ease-in-out  placeholder:text-backgroundGrey placeholder: focus:bg-transparent focus:border-textGrey focus:outline-none"
                placeholder="0"
              />
            </form>
          </div>
